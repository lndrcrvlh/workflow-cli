...
module.exports = (args) => {
  ...
  var inquirer = require('inquirer'); //prompts user and stores data
  ...
  const lib = require('../lib/constants') //atm, this file is mostly commented out
  try{
         // clear the terminal
    console.log('\u001B[2J\u001B[0;0f');
    inquirer.prompt([
      ...
      //end prompts start err handling
    ], function(answers) {
  ...
  function deployProcesses(options) {
      // get the files of the chosen directory
